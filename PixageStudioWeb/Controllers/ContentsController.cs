...
namespace PixageStudioWeb.Controllers
{
    public class ContentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Data,Category,FontName,FontSize")] Content content)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Data,Category,FontName,FontSize")] Content content)
        {
            if (id != content.Id)
            {
                return NotFound();
